			...
			<div class="pageHead">
				<table>
			        <tr>
			            ...
			            <th align="left" class="title_area">当前位置：合同管理 &gt; 合同模板 &gt;  修改合同模板</th>
			...
			<div class="pageBody">
				<table class="mytable" border="0">
					<tr>
						<th>合同名称</th>
						<td >
							<input type="text" value="合同1"><span class="required">*</span>
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						...
						<td>
							<textarea rows="5" cols="28">备注信息</textarea>													
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<div class="buttonBar">
								...
								<input id="btnReset" type="button" class="mybutton" value="更新"
									onclick="javascript:history.go(-1)">
							</div>
						</td>
					</tr>
