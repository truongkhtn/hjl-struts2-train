		...
		<div class="content">
			<div class="pageHead">
				<table>
			        <tr>
			            ...
			            <th align="left" class="title_area">当前位置：客户管理 &gt; 公海客户</th>
			...
			<div class="pageBody">
				...
				<div class="pager-container">
					<ul class="pager">
					    <li class="pageInfo">
					    	<input type="button" class="mybutton pickCustomer" value="捡选客户"> 
					    </li>
					</ul>
				</div>
				<table class="mytable resultTable">
					...
					<tr>
						...
						<td>2012-1-1</td>
						<td><a href="info.html">XXX有限公司</a></td>
						<td>张三</td>
						<td>xx大街xx大道xx号</td>
						<td>业务员A</td>
						<td>
							<a href="history.html">拜访记录</a>
							<a href="contactList.html">联系人</a>
						</td>
					</tr>
					<tr>
