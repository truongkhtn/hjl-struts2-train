		...
		<div class="content">
			<div class="pageHead">
				<table>
			        <tr>
			            ...
			            <th align="left" class="title_area">当前位置：合同管理 &gt; 合同模板</th>
			...
			<div class="pageBody">
				<div class="pager-container">
					<ul class="pager">
					    <li class="pageInfo">
					    	<input type="button" class="mybutton" value="新建模板" 
					    		onclick="javascript:location.href='templateCreate.html'"> 
					    </li>
					</ul>
				</div>
				<table class="mytable resultTable">
					...
					<tr>
						<td>合同1</td>
						<td>测试1</td>
						<td><b style="color:green">启用</b></td>
						<td>
							<a href="propertyList.html">自定义属性</a>
							<a href="templateEdit.html">修改</a>
							<a href="templateList.html">删除</a>
						</td>
					</tr>
					<tr>
						<td>合同2</td>
