...
<table class="pageHead">
    <tr>
        ...
        <th align="left" class="title_area">当前位置：查看线路报价</th>
...
<table width="90%" cellspacing="0" cellpadding="0" border="0" class="pro_table">
    ...
    <tr>
        ...
        <td width="40%">
            <s:property escape="false" value="routePrice.startFlightInfo.replaceAll('\n','<br>').trim()"/>
        </td>
        <td width="10%" class="pro_color2">返程航班:</td>
        <td width="40%">
            <s:property escape="false" value="routePrice.endFlightInfo.replaceAll('\n','<br>').trim()"/>
        </td>
    </tr>
    <tr>
        <td width="10%" class="pro_color2">儿童门市价:</td>
        <td width="40%">
            <s:property escape="false" value="routePrice.childenPrice.replaceAll('\n','<br>').trim()"/>
        </td>
        <td width="10%" class="pro_color2">成人门市价:</td>
        <td width="40%">
            <s:property escape="false" value="routePrice.adultPrice.replaceAll('\n','<br>').trim()"/>
        </td>
    </tr>
    <tr>
...
<table id="journeyInfo" width="90%" cellspacing="0" cellpadding="0" border="0" class="pro_table">
    ...
    <s:iterator value="routePrice.route.journeySet" id="journey" status="st">
        <tr class="journeyClass">
            <td class="center">
                <s:property escape="false" value='#st.index + 1'/>
            </td>
            <td>
